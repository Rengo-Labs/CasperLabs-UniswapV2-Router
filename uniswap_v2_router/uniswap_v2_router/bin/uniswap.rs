...
fn remove_liquidity() 
{
    ...
    let (amount_a, amount_b) :(U256, U256) = Uniswap::default().remove_liquidity(_token_a, _token_b, liquidity, amount_a_min, amount_b_min, to);
...
/// v:u8, r:u32, s:u32, deadline:U256
