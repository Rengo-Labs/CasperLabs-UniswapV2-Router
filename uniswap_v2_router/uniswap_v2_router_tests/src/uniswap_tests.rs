...
// - Self mint tokens
// - Complete swap functions
// - Some fixes in Library contract required
//      - Self function should be called through entry points
//      - Need to fix datatypes, variables names, order for some functions