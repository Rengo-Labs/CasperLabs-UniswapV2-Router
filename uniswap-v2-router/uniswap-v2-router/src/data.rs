...
pub fn wcspr() -> ContractPackageHash { get_key(WCSPR).unwrap_or_revert() }
pub fn set_wcspr(_wcspr: ContractPackageHash) { set_key(WCSPR, _wcspr); }

pub fn factory() -> ContractPackageHash { get_key(FACTORY).unwrap_or_revert()}
pub fn set_factory(_factory: ContractPackageHash) { set_key(FACTORY, _factory);}

pub fn library_hash() -> ContractPackageHash { get_key(LIBRARY_HASH).unwrap_or_revert()}
pub fn set_library_hash(library_hash: ContractPackageHash) { set_key(LIBRARY_HASH, library_hash);}
